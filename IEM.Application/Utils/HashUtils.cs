...
namespace IEM.Application.Utils
{
    public static class HashUtils
    {
        ...
        public static string HashPassword(string password)
        {
            ...
            var bytes = HashPasswordV3(password, KeyDerivationPrf.HMACSHA512, Pbkdf2Iterations, saltSize, numBytesRequested);
            return Convert.ToBase64String(bytes);
        }

        public static bool VerifyHashedPassword(string hashedPasswordStr, string passwordText)
        {
            ...
            try
            {
                ...
                byte[] actualSubkey = KeyDerivation.Pbkdf2(passwordText, salt, prf, iterCount, subkeyLength);
        ...
        {
            byte[] salt = RandomUtils.GenerateRandomBytes(saltSize);
        ...
        public static string HashString(string string2Hash)
        {
            try
            {
                ...
                byte[] textData = Encoding.UTF8.GetBytes(string2Hash);
